...
class DotSwiperPaginationBuilder extends SwiperPlugin {
  ...
  Widget build(BuildContext context, SwiperPluginConfig config) {
    ...
    if (activeColor == null || color == null) {
      ...
      color = this.color ?? Colors.white.withOpacity(0.7);
    }
...
class FlatSwiperPaginationBuilder extends SwiperPlugin {
  ///color when current index,if set null , will be Theme.of(context).primaryColor
  final Color activeColor;
  ...
  const FlatSwiperPaginationBuilder(
      {this.activeColor,
      this.color,
      this.key,
      this.size: 10.0,
  ...
  Widget build(BuildContext context, SwiperPluginConfig config) {
    if (config.itemCount > 20) {
      ...
      print(
          "The itemCount is too big, we suggest use FractionPaginationBuilder instead of FlatSwiperPaginationBuilder in this sitituation");
    }
    Color activeColor = this.activeColor;
    Color color = this.color;
    ...
    if (activeColor == null || color == null) {
      ThemeData themeData = Theme.of(context);
      activeColor = this.activeColor ?? Colors.white;
      color = this.color ?? Colors.white.withOpacity(0.5);
    }
...
class SwiperPagination extends SwiperPlugin {
  ...
  static const SwiperPlugin flat = const FlatSwiperPaginationBuilder();
